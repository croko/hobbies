...
class ClassroomsControllerTest < ActionController::TestCase
  ...
  test "should create classroom" do
    assert_difference('Classroom.count') do
      post :create, classroom: { name: @classroom.name, partner_id: @classroom.partner_id, seats: @classroom.seats }
    end
  ...
  test "should update classroom" do
    put :update, id: @classroom, classroom: { name: @classroom.name, partner_id: @classroom.partner_id, seats: @classroom.seats }
    assert_redirected_to classroom_path(assigns(:classroom))
  end
